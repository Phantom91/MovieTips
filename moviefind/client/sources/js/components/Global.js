...
var _Global = function() {
  ...
  var handleEqualHeight = function() {
   ...
   var registerSwipeModule = function(){
      $(".swipe-area").swipe({
          swipeStatus:function(event, phase, direction, distance, duration, fingers)
          {
              if (phase=="move" && direction =="right") {
                  ...
                  $(".container-with-sidebar").addClass("open-sidebar");
                  $('[data-toggle=".container-with-sidebar"]').removeClass('closed');
                  $('[data-toggle=".container-with-sidebar"]').addClass('opened');
                  return false;
              }
              if (phase=="move" && direction =="left") {
                  $('html').removeClass('sidebar-opened');
                  $('body').removeClass('sidebar-opened');
                  $(".container-with-sidebar").removeClass("open-sidebar");
                  $('[data-toggle=".container-with-sidebar"]').removeClass('opened');
                  $('[data-toggle=".container-with-sidebar"]').addClass('closed');
                  return false;
              }
          }
      });  
