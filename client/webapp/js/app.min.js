...
},{"whatwg-fetch":8}],4:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var API_ENDPOINT="http://localhost:9080/moviefind/api",_DefaultLanguage="en",_RenderService=API_ENDPOINT+"/render",_TemplatesPath="client/webapp/templates",AppConfig={get API_ENDPOINT(){return API_ENDPOINT},get DefaultLanguage(){return _DefaultLanguage},get RenderService(){return _RenderService},get TemplatesPath(){return _TemplatesPath}};exports.default=AppConfig;
},{}],10:[function(require,module,exports){
"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),_DataService=require("./DataService"),_DataService2=_interopRequireDefault(_DataService),_AppConfig=require("../AppConfig"),_AppConfig2=_interopRequireDefault(_AppConfig),_Utils=require("./Utils"),_Utils2=_interopRequireDefault(_Utils),BaseController=function(){function BaseController(data,renderProperties,afterRenderCallback){_classCallCheck(this,BaseController),this.data=data,renderProperties&&this.renderTemplate(renderProperties).then(function(template){"function"==typeof afterRenderCallback&&afterRenderCallback(template)}).catch(function(err){return console.error(err)})}return _createClass(BaseController,null,[{key:"created",get:function(){return _created},set:function(value){_created=value}}]),_createClass(BaseController,[{key:"renderTemplate",value:function(renderProperties,data){var _this=this,promise=null;return renderProperties.renderOnServer?promise=new Promise(function(resolve,reject){_DataService2.default.post(_AppConfig2.default.RenderService+"/"+renderProperties.templatePath,_this.data||data||{},function(template){return resolve(template)},reject,!1)}):renderProperties.renderOnClient&&(promise=new Promise(function(resolve){_Utils2.default.TemplateManager.renderTemplate(_AppConfig2.default.TemplatesPath+"/"+renderProperties.templatePath,_this.data||data||{},function(template){return resolve(template)})})),promise}}]),BaseController}();exports.default=BaseController;
},{"../AppConfig":9,"./DataService":12,"./Utils":17}],11:[function(require,module,exports){
"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}function _interopRequireWildcard(obj){if(obj&&obj.__esModule)return obj;var newObj={};if(null!=obj)for(var key in obj)Object.prototype.hasOwnProperty.call(obj,key)&&(newObj[key]=obj[key]);return newObj.default=obj,newObj}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),_underscore=require("underscore"),_=_interopRequireWildcard(_underscore),_backbone=require("backbone"),_backbone2=_interopRequireDefault(_backbone),_Utils=require("./Utils"),_Utils2=_interopRequireDefault(_Utils),_DataStore=require("./DataStore"),_DataStore2=_interopRequireDefault(_DataStore),BaseView=function(){function BaseView(element,template){_classCallCheck(this,BaseView),this.element=element,this.template=template}return _createClass(BaseView,[{key:"createBackboneView",value:function(prototype){var _this=this,self=this;this._view=_backbone2.default.View.extend({el:this.element,initialize:function(){if(this.render(),prototype=prototype||{},!prototype.viewModel){var viewModelProto=_backbone2.default.Model.extend({});this.viewModel=new viewModelProto}prototype.useDataStore?_Utils2.default.Helpers.bindBackboneModelsFromDom(this,_DataStore2.default):_Utils2.default.Helpers.bindBackboneModelsFromDom(this,prototype.viewModel||this.viewModel),"function"==typeof prototype.initCallback&&prototype.initCallback(this)},render:function(){self.template&&this.$el.html(self.template),"function"==typeof prototype.afterRenderCallback&&prototype.afterRenderCallback(self.template||"")}}),_.mapObject(prototype,function(value,key){_this._view.prototype[key]=prototype[key]}),new this._view}},{key:"destroy",value:function(afterDestroyCallback){this._view.remove(),"function"==typeof afterDestroyCallback&&setTimeout(afterDestroyCallback,0)}}]),BaseView}();exports.default=BaseView;
},{"./DataStore":13,"./Utils":17,"backbone":1,"underscore":7}],12:[function(require,module,exports){
"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}function _interopRequireWildcard(obj){if(obj&&obj.__esModule)return obj;var newObj={};if(null!=obj)for(var key in obj)Object.prototype.hasOwnProperty.call(obj,key)&&(newObj[key]=obj[key]);return newObj.default=obj,newObj}Object.defineProperty(exports,"__esModule",{value:!0}),require("isomorphic-fetch");var _underscore=require("underscore"),_=_interopRequireWildcard(_underscore),_es6Promise=require("es6-promise"),es6Promise=_interopRequireWildcard(_es6Promise),_backbone=require("backbone"),_AppConfig=require("../AppConfig"),_AppConfig2=_interopRequireDefault(_AppConfig);es6Promise.polyfill();var DataService={cache:{},get:function(url,cacheData,cacheKey,successCallback,errCallback){cacheData&&!cacheKey&&(cacheKey="data");var self=this;!cacheData||cacheData&&!this.cache[cacheKey]?fetch(url,{method:"get"}).then(function(response){if(response.ok)return response;throw new Error("Internal server error")}).then(function(response){var data=null;try{data=response.json(),cacheData&&(self.cache[cacheKey]=data),"function"==typeof successCallback&&successCallback(data)}catch(err){"function"==typeof errCallback?errCallback(err):console.error(err)}}).catch(function(err){"function"==typeof errCallback?errCallback(err):console.error(err)}):"function"==typeof successCallback&&successCallback(this.cache[cacheKey])},post:function(url,requestData,successCallback,errCallback){var expectJSON=!(arguments.length>4&&void 0!==arguments[4])||arguments[4];fetch(url,{method:"post",body:JSON.stringify(requestData),headers:{"Content-Type":"application/json"}}).then(function(response){if(response.ok)return response;throw new Error("Internal server error")}).then(function(response){var data=null;try{data=expectJSON?response.json():response.text(),"function"==typeof successCallback&&successCallback(data)}catch(err){"function"==typeof errCallback?errCallback(err):console.error(err)}}).catch(function(err){"function"==typeof errCallback?errCallback(err):console.error(err)})},loadDataIntoCollection:function(path,collectionName,data,successCallback,errCallback){var model=_backbone.Model.extend({initialize:function(){$.ajaxPrefilter(function(options){options.crossDomain={crossDomain:!0}})}}),collection=_backbone.Collection.extend({url:_AppConfig2.default.API_ENDPOINT+path,model:model,data:data||{},name:collectionName}),newCollection=new collection;return newCollection.fetch({success:successCallback,error:errCallback}),newCollection},loadDataIntoCollections:function(data,successCallback,errCallback){var _$,collectionsPromisesBuffer=[],collectionsData={};_.each(data,function(collectionData){var model=_backbone.Model.extend({initialize:function(){$.ajaxPrefilter(function(options){options.crossDomain={crossDomain:!0}})}}),options={model:model,name:collectionData.name,data:collectionData.data||{}};collectionData.url?options.url=collectionData.url:collectionData.path&&(options.url=_AppConfig2.default.API_ENDPOINT+collectionData.path);var collection=_backbone.Collection.extend(options),newCollection=new collection;collectionsPromisesBuffer.push(newCollection.fetch({success:function(result){collectionsData[collectionData.name]=result},error:errCallback,data:newCollection.data||{}}))}),(_$=$).when.apply(_$,collectionsPromisesBuffer).done(function(){successCallback(collectionsData)})}};exports.default=DataService;
},{"../AppConfig":9,"backbone":1,"es6-promise":2,"isomorphic-fetch":3,"underscore":7}],13:[function(require,module,exports){
"use strict";
},{}],14:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var _Global=function(){var handleBootstrapComponents=function(){$(".carousel").carousel({interval:5e3,pause:"hover"}),$(".tooltips").tooltip(),$(".tooltips-show").tooltip("show"),$(".tooltips-hide").tooltip("hide"),$(".tooltips-toggle").tooltip("toggle"),$(".tooltips-destroy").tooltip("destroy"),$(".popovers").popover(),$(".popovers-show").popover("show"),$(".popovers-hide").popover("hide"),$(".popovers-toggle").popover("toggle"),$(".popovers-destroy").popover("destroy")},handleScrollToSection=function(){$(function(){$("a[href*=\\#js__scroll-to-]:not([href=\\#js__scroll-to-])").on("click",function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var target=$(this.hash);if(target=target.length?target:$("[name="+this.hash.slice(1)+"]"),target.length)return $("html,body").animate({scrollTop:target.offset().top-90},1e3),!1}})})},handlePromoSection=function(){$(".js__fullwidth-img").each(function(){$(this).css("background-image","url("+$(this).children("img").attr("src")+")"),$(this).children("img").hide()})},handleOverlay=function(){var overlay=$(".js__bg-overlay"),headerOverlay=$(".js__header-overlay"),trigger=$(".js__trigger");trigger.on("click",function(){overlay.toggleClass("-is-open"),headerOverlay.toggleClass("-is-open"),trigger.toggleClass("-is-active")})},handleVerticalCenterAligned=function(){$(".js__ver-center-aligned").each(function(){$(this).css("padding-top",$(this).parent().height()/2-$(this).height()/2)}),$(window).resize(function(){$(".js__ver-center-aligned").each(function(){$(this).css("padding-top",$(this).parent().height()/2-$(this).height()/2)})})},handleEqualHeight=function(){$("[data-auto-height]").each(function(){var parent=$(this),items=$("[data-height]",parent),height=0,mode=parent.attr("data-mode"),offset=parseInt(parent.attr("data-offset")?parent.attr("data-offset"):0);items.each(function(){"height"==$(this).attr("data-height")?$(this).css("height",""):$(this).css("min-height","");var height_="base-height"==mode?$(this).outerHeight():$(this).outerHeight(!0);height_>height&&(height=height_)}),height+=offset,items.each(function(){"height"==$(this).attr("data-height")?$(this).css("height",height):$(this).css("min-height",height)}),parent.attr("data-related")&&$(parent.attr("data-related")).css("height",parent.height())})},registerSwipeModule=function(){$(".swipe-area").swipe({swipeStatus:function(event,phase,direction,distance,duration,fingers){return"move"==phase&&"right"==direction?($("html").addClass("sidebar-opened"),$("body").addClass("sidebar-opened"),$(".container-with-sidebar").addClass("open-sidebar"),$('[data-toggle=".container-with-sidebar"]').removeClass("closed"),$('[data-toggle=".container-with-sidebar"]').addClass("opened"),!1):"move"==phase&&"left"==direction?($("html").removeClass("sidebar-opened"),$("body").removeClass("sidebar-opened"),$(".container-with-sidebar").removeClass("open-sidebar"),$('[data-toggle=".container-with-sidebar"]').removeClass("opened"),$('[data-toggle=".container-with-sidebar"]').addClass("closed"),!1):void 0}})};return{init:function(){handleBootstrapComponents(),handleScrollToSection(),handlePromoSection(),handleOverlay(),handleVerticalCenterAligned(),handleEqualHeight(),registerSwipeModule()}}}(),Global=exports.Global=_Global;
},{}],15:[function(require,module,exports){
"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(self,call){if(!self)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!call||"object"!=typeof call&&"function"!=typeof call?self:call}function _inherits(subClass,superClass){if("function"!=typeof superClass&&null!==superClass)throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:!1,writable:!0,configurable:!0}}),superClass&&(Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass)}Object.defineProperty(exports,"__esModule",{value:!0});var _BaseView2=require("./BaseView"),_BaseView3=_interopRequireDefault(_BaseView2),_LoginFormValidation=require("./login/LoginFormValidation"),_LoginFormValidation2=_interopRequireDefault(_LoginFormValidation),_FacebookLogin=require("./login/FacebookLogin"),_FacebookLogin2=_interopRequireDefault(_FacebookLogin),Navbar=function(_BaseView){function Navbar(){_classCallCheck(this,Navbar);var _this=_possibleConstructorReturn(this,(Navbar.__proto__||Object.getPrototypeOf(Navbar)).call(this,"#navbar"));return _this.createBackboneView({events:{'click [data-toggle="modal-login"]':"showLoginModal"},showLoginModal:function(evt){$("#loginModalForm").modal("show"),_LoginFormValidation2.default.init()}}),_this}return _inherits(Navbar,_BaseView),Navbar}(_BaseView3.default);exports.default=Navbar;
},{"./BaseView":11,"./login/FacebookLogin":20,"./login/LoginFormValidation":21}],16:[function(require,module,exports){
"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(self,call){if(!self)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!call||"object"!=typeof call&&"function"!=typeof call?self:call}function _inherits(subClass,superClass){if("function"!=typeof superClass&&null!==superClass)throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:!1,writable:!0,configurable:!0}}),superClass&&(Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),_backbone=require("backbone"),_backbone2=_interopRequireDefault(_backbone),_SidebarController=require("./sidebar/SidebarController.js"),_SidebarController2=_interopRequireDefault(_SidebarController),_LandingPageController=require("./landing-page/LandingPageController.js"),_LandingPageController2=_interopRequireDefault(_LandingPageController),Router=function(_Backbone$Router){function Router(routes){_classCallCheck(this,Router);var _this=_possibleConstructorReturn(this,(Router.__proto__||Object.getPrototypeOf(Router)).call(this,routes));return _this.routes=routes||{"":"showIndex","/movies":"showMovies","/news":"showNews","/friends":"showFriends","/profile":"showProfile"},_this.sections=[],_this._bindRoutes(),_this}return _inherits(Router,_Backbone$Router),_createClass(Router,[{key:"showIndex",value:function(){this.tabId="home",this.switchToSection()}},{key:"showMovies",value:function(){this.tabId="movies",this.switchToSection()}},{key:"showNews",value:function(){this.tabId="news",this.switchToSection()}},{key:"showProfile",value:function(){this.tabId="movies",this.switchToSection()}},{key:"showFriends",value:function(){this.tabId="movies",this.switchToSection()}},{key:"setActiveView",value:function(tabId){var _iteratorNormalCompletion=!0,_didIteratorError=!1,_iteratorError=void 0;try{for(var _step,_iterator=this.sections[Symbol.iterator]();!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=!0){var section=_step.value;section.tabId!=tabId?($("#"+section.tabId+"-view").hide(),$("#"+section.tabId).removeClass("active")):($("#"+section.tabId+"-view").show(),$("#"+section.tabId).addClass("active"))}}catch(err){_didIteratorError=!0,_iteratorError=err}finally{try{!_iteratorNormalCompletion&&_iterator.return&&_iterator.return()}finally{if(_didIteratorError)throw _iteratorError}}}},{key:"switchToSection",value:function(){this.setActiveView(this.tabId);var _iteratorNormalCompletion2=!0,_didIteratorError2=!1,_iteratorError2=void 0;try{for(var _step2,_iterator2=this.sections[Symbol.iterator]();!(_iteratorNormalCompletion2=(_step2=_iterator2.next()).done);_iteratorNormalCompletion2=!0){var section=_step2.value;section.tabId==this.tabId?$("#"+section.id).show():$("#"+section.id).hide()}}catch(err){_didIteratorError2=!0,_iteratorError2=err}finally{try{!_iteratorNormalCompletion2&&_iterator2.return&&_iterator2.return()}finally{if(_didIteratorError2)throw _iteratorError2}}switch(this.tabId){case"home":new _SidebarController2.default(_LandingPageController2.default)}}},{key:"setUrl",value:function(url){this.navigate(url,!1)}},{key:"navigateTo",value:function(link){this.navigate(link,{trigger:!0})}}]),Router}(_backbone2.default.Router);exports.default=Router;
},{"./landing-page/LandingPageController.js":18,"./sidebar/SidebarController.js":23,"backbone":1}],17:[function(require,module,exports){
"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}Object.defineProperty(exports,"__esModule",{value:!0});var _underscore=require("underscore"),_underscore2=_interopRequireDefault(_underscore),_backbone=require("backbone"),_backbone2=_interopRequireDefault(_backbone),UtilsClass=function(){var _events={},instance=null;_underscore2.default.extend(_events,_backbone2.default.Events);var _UtilsClassPrototype=function(){return{TemplateManager:{templates:{},loadTemplateFromFile:function(file,data,options,callback){var _this=this;options||(options={}),this.templates[file]?"function"==typeof callback&&callback(this.templates[file],data,options):file&&$.get(file+".ejs",function(template){_this.templates[file]=template,"function"==typeof callback&&callback(template,data,options)}).fail(function(err){console.error(err)})},loadPartial:function(file,data){var _this2=this;return new Promise(function(resolve,reject){_this2.templates[file]?resolve(_this2.templates[file]):$.get(file+".ejs",function(template){resolve(template)}).fail(function(err){reject(err)})})},renderTemplate:function(file,data,callback){var self=this,_renderTemplate=function(template,_callback){var htmlFromTemplate=_underscore2.default.template(template).call(self,data);"function"==typeof _callback&&_callback(htmlFromTemplate)},_renderPartial=function(template,partial,token,data){var compiledPartial=_underscore2.default.template(partial).call(self,data);return template.replace("<%- @include"+token+"-%>",compiledPartial)},_loadPartials=function(template,tokens){var partials=[],promises=[];_underscore2.default.each(tokens,function(token){if(-1!==token.indexOf("-%>")){var includeTokens=token.split("-%>"),expression=includeTokens[0].substring(includeTokens[0].indexOf("("),token.indexOf(")")).replace(/\(|\)/g,""),params=expression.split(",");if(params=params.map(function(value){return value.trim()}),params=params.map(function(value){return value.replace(/"/g,"")}),params[1].includes("this.")){var dataTokens=params[1].split(".");dataTokens[1]=dataTokens[1].replace(/(\s*\'\s*})|(\s*\"\s*})|(\s*}*)/g,"");var newExpression="<%= JSON.stringify("+dataTokens[1]+") %>",parsedParam=_underscore2.default.template(newExpression).call(self,data);parsedParam.includes("{")||(parsedParam=JSON.parse(parsedParam)),params[1]=params[1].replace("this."+dataTokens[1],parsedParam)}(0,eval)("MainApp.passData="+params[1]),partials.push({file:params[0],data:MainApp.passData,token:includeTokens[0]})}}),_underscore2.default.each(partials,function(partial){promises.push(self.loadPartial(partial.file,partial.data))});var newTemplate=template;Promise.all(promises).then(function(templates){_underscore2.default.each(partials,function(partial,index){newTemplate=_renderPartial(newTemplate,templates[index],partial.token,partial.data)}),_renderTemplate(newTemplate,callback)})};this.loadTemplateFromFile(file,data,{},function(template){if(-1!==template.indexOf("<%- @include")){var tokens=template.split("<%- @include");_loadPartials(template,tokens)}else _renderTemplate(template,callback)})},renderSubTemplate:function(options,elementID,data,callback){if(options.template)return void $("#"+elementID).html(options.template);var template=null;if(options.isInlined&&(template=$("script[template-id='"+elementID+"']").html()),template){var htmlFromTemplate=_underscore2.default.template(template).call(this,data);$("#"+elementID).html(htmlFromTemplate),"function"==typeof callback&&callback(data)}else this.renderTemplate(options.file,data,function(html){$("#"+elementID).html(html),"function"==typeof callback&&callback(data)})}},Helpers:{getIEVersion:function(){var sAgent=window.navigator.userAgent,Idx=sAgent.indexOf("MSIE");return Idx>0?parseInt(sAgent.substring(Idx+5,sAgent.indexOf(".",Idx))):navigator.userAgent.match(/Trident\/7\./)||window.navigator.userAgent.indexOf("Edge")>-1?11:0},capitalizeFirstLetter:function(string){return""+string.charAt(0).toUpperCase()+string.slice(1)},renderModal:function(modalId){0==$("body #modals > #"+modalId).length&&$("body #modals").append($("#"+modalId).detach()),$("#"+modalId).modal({backdrop:"static",keyboard:!0})},hexToRgba:function(hex,opacity){return hex=hex.replace("#",""),"rgba("+parseInt(hex.substring(0,2),16)+","+parseInt(hex.substring(2,4),16)+","+parseInt(hex.substring(4,6),16)+","+opacity/100+")"},registerHelper:function(name,fn){MainApp.Helpers[name]=fn},bindBackboneModelsFromDom:function(scope,model){var modelsFromDom=$("[data-backbone-model]"),_updateModel=function(modelId,modelValue,modelChange,validationMethod){validationMethod&&"function"==typeof scope[validationMethod]&&scope[validationMethod](modelValue)?(model.set(modelId,modelValue),modelChange&&scope[modelChange](modelValue)):validationMethod||(model.set(modelId,modelValue),modelChange&&scope[modelChange](modelValue))};$.each(modelsFromDom,function(index,elem){var modelId=$(elem).attr("data-backbone-model"),watchEvent=$(elem).attr("data-watch-event")||"change",debounceTimer=parseInt($(elem).attr("data-debounce"))||0,validationMethod=$(elem).attr("validation-method")||null,modelChange=$(elem).attr("data-model-change")||null;debounceTimer?$(elem).on(watchEvent,_underscore2.default.debounce(function(evt){_updateModel(modelId,evt.currentTarget.value,modelChange,validationMethod)},debounceTimer)):$(elem).on(watchEvent,function(evt){return _updateModel(modelId,evt.currentTarget.value,modelChange,validationMethod)})})}},Events:{subscribe:function(evt,handler){_events.on(evt,handler)},unsubscribe:function(evt,handler){_events.off(evt,handler)},trigger:function(evt,data){_events.trigger(evt,data)}}}};return{getInstance:function(){return null==instance&&(instance=new _UtilsClassPrototype,instance.constructor=null),instance}}}(),Utils=UtilsClass.getInstance();exports.default=Utils;
},{"backbone":1,"underscore":7}],18:[function(require,module,exports){
"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(self,call){if(!self)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!call||"object"!=typeof call&&"function"!=typeof call?self:call}function _inherits(subClass,superClass){if("function"!=typeof superClass&&null!==superClass)throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:!1,writable:!0,configurable:!0}}),superClass&&(Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),_Global=require("../Global"),_portfolio3Col=require("../third-party/portfolio-3-col"),_LandingPageView=require("./LandingPageView.js"),_LandingPageView2=_interopRequireDefault(_LandingPageView),_DataService=require("../DataService"),_DataService2=_interopRequireDefault(_DataService),_BaseController2=require("../BaseController"),_BaseController3=_interopRequireDefault(_BaseController2),LandingPageController=function(_BaseController){function LandingPageController(){_classCallCheck(this,LandingPageController);var _this=_possibleConstructorReturn(this,(LandingPageController.__proto__||Object.getPrototypeOf(LandingPageController)).call(this));return _this._viewInstance=new _LandingPageView2.default,_this.renderPopularMovies(),_this}return _inherits(LandingPageController,_BaseController),_createClass(LandingPageController,[{key:"renderPopularMovies",value:function(){var _this2=this;_DataService2.default.loadDataIntoCollection("/GetPopularMovies","Movies",{},function(movies){_this2.popularMovies=movies,_this2.renderTemplate({renderOnServer:!0,templatePath:"partials/movies-grid"},{movies:movies.toJSON()}).then(function(template){$("#movies-grid").html(template),setTimeout(function(){$(".cbp.col-centered").addClass("hide-loader"),_portfolio3Col.Portfolio3Col.init(),_Global.Global.init()},0)}).catch(function(err){return console.error(err)})},function(err){console.error(err)})}}]),LandingPageController}(_BaseController3.default);exports.default=LandingPageController;
},{"../BaseController":10,"../DataService":12,"../Global":14,"../third-party/portfolio-3-col":27,"./LandingPageView.js":19}],19:[function(require,module,exports){
"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(self,call){if(!self)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!call||"object"!=typeof call&&"function"!=typeof call?self:call}function _inherits(subClass,superClass){if("function"!=typeof superClass&&null!==superClass)throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:!1,writable:!0,configurable:!0}}),superClass&&(Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass)}Object.defineProperty(exports,"__esModule",{value:!0});var _scrollbar=require("../third-party/scrollbar"),_magnificPopup=require("../third-party/magnific-popup"),_swipers=require("../third-party/swipers"),_counter=require("../third-party/counter"),_parallax=require("../third-party/parallax"),_wow=require("../third-party/wow"),_BaseView2=require("../BaseView"),_BaseView3=_interopRequireDefault(_BaseView2),LandingPageView=function(_BaseView){function LandingPageView(){_classCallCheck(this,LandingPageView);var _this=_possibleConstructorReturn(this,(LandingPageView.__proto__||Object.getPrototypeOf(LandingPageView)).call(this,"#landing-page"));return _this.createBackboneView({afterRenderCallback:function(){setTimeout(function(){_scrollbar.Scrollbar.init(),_magnificPopup.MagnificPopup.init(),_swipers.Swipers.init(),_counter.Counter.init(),_parallax.Parallax.init(),_wow.Wow.init()},0)}}),_this}return _inherits(LandingPageView,_BaseView),LandingPageView}(_BaseView3.default);exports.default=LandingPageView;
},{"../BaseView":11,"../third-party/counter":24,"../third-party/magnific-popup":25,"../third-party/parallax":26,"../third-party/scrollbar":28,"../third-party/swipers":29,"../third-party/wow":30}],20:[function(require,module,exports){
arguments[4][13][0].apply(exports,arguments)
},{"dup":13}],21:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var _init=function(){!function($){function validate(input){if("email"==$(input).attr("type")||"email"==$(input).attr("name")){if(null==$(input).val().trim().match(/^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\.)+))([a-zA-Z]{1,5}|[0-9]{1,3})(\]?)$/))return!1}else if(""==$(input).val().trim())return!1}function showValidate(input){var thisAlert=$(input).parent();$(thisAlert).addClass("alert-validate")}function hideValidate(input){var thisAlert=$(input).parent();$(thisAlert).removeClass("alert-validate")}$(".input100").each(function(){$(this).on("blur",function(){""!=$(this).val().trim()?$(this).addClass("has-val"):$(this).removeClass("has-val")})});var input=$(".validate-input .input100");$(".validate-form").on("submit",function(){for(var check=!0,i=0;i<input.length;i++)0==validate(input[i])&&(showValidate(input[i]),check=!1);return check}),$(".validate-form .input100").each(function(){$(this).focus(function(){hideValidate(this)})})}(jQuery)},LoginFormValidation={init:_init};exports.default=LoginFormValidation;
},{}],22:[function(require,module,exports){
"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}var _backbone=require("backbone"),_backbone2=_interopRequireDefault(_backbone),_Utils=require("../Utils"),_Utils2=_interopRequireDefault(_Utils),_AppConfig=require("../../AppConfig"),_AppConfig2=_interopRequireDefault(_AppConfig),_Router=require("../Router"),_Router2=_interopRequireDefault(_Router),_moment=require("moment"),_moment2=_interopRequireDefault(_moment);window.moment=_moment2.default,window.MainApp={},MainApp.Helpers=_Utils2.default.Helpers;var MovieTips=function MovieTips(model){return _classCallCheck(this,MovieTips),new(_backbone2.default.View.extend({el:"#main-app",events:{'click [data-toggle=".container-with-sidebar"]':"handleToggleClick"},initialize:function(){MainApp.language=_AppConfig2.default.DefaultLanguage,_backbone2.default.history=_backbone2.default.history||new _backbone2.default.History({});new _Router2.default;_backbone2.default.history.start({pushState:!0,root:"/moviefind"}),this.listenTo(this.model,"change",this.render)},render:function(){},handleToggleClick:function(evt){var el=$(evt.currentTarget),toggleEl=el.data("toggle");$(toggleEl).toggleClass("open-sidebar"),el.hasClass("opened")?($("body").removeClass("sidebar-opened"),el.removeClass("opened"),el.addClass("closed")):($("body").addClass("sidebar-opened"),el.removeClass("closed"),el.addClass("opened"))}}))(model)};new MovieTips;
},{"../../AppConfig":9,"../Router":16,"../Utils":17,"backbone":1,"moment":5}],23:[function(require,module,exports){
"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(self,call){if(!self)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!call||"object"!=typeof call&&"function"!=typeof call?self:call}function _inherits(subClass,superClass){if("function"!=typeof superClass&&null!==superClass)throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:!1,writable:!0,configurable:!0}}),superClass&&(Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1,descriptor.configurable=!0,"value"in descriptor&&(descriptor.writable=!0),Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){return protoProps&&defineProperties(Constructor.prototype,protoProps),staticProps&&defineProperties(Constructor,staticProps),Constructor}}(),_BaseController2=require("../BaseController"),_BaseController3=_interopRequireDefault(_BaseController2),_Navbar=require("../Navbar"),_Navbar2=_interopRequireDefault(_Navbar),SidebarController=function(_BaseController){function SidebarController(renderController,renderProperties,data){if(_classCallCheck(this,SidebarController),new _Navbar2.default,renderProperties)var _this=_possibleConstructorReturn(this,(SidebarController.__proto__||Object.getPrototypeOf(SidebarController)).call(this,data,renderProperties,function(template){new renderController(template)}));else{var _this=_possibleConstructorReturn(this,(SidebarController.__proto__||Object.getPrototypeOf(SidebarController)).call(this));new renderController}return _possibleConstructorReturn(_this)}return _inherits(SidebarController,_BaseController),_createClass(SidebarController,[{key:"renderContent",value:function(){}}]),SidebarController}(_BaseController3.default);exports.default=SidebarController;
},{"../BaseController":10,"../Navbar":15}],24:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var _Counter=function(){var handleCounter=function(){$(".js__counter").counterUp()};return{init:function(){handleCounter()}}}(),Counter=exports.Counter=_Counter;
},{}],25:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var _MagnificPopup=function(){var handleMagnificPopup=function(){$(document).ready(function(){$(".js__popup__image").magnificPopup({type:"image",closeOnContentClick:!0,mainClass:"mfp-img-mobile",image:{verticalFit:!0}})}),$(document).ready(function(){$(".js__popup__gallery").magnificPopup({delegate:"a.js__popup__gallery-child",type:"image",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]},image:{tError:'<a href="%url%">The image #%curr%</a> could not be loaded.'}})}),$(document).ready(function(){$(".js__popup__multiple-image").magnificPopup({type:"image",tLoading:"Loading image #%curr%...",fixedContentPos:!0,gallery:{enabled:!0,navigateByImgClick:!0,arrowMarkup:'<button title="%title%" type="button" class="mfp-arrow mfp-arrow-%dir%"></button>',preload:[0,1]}})}),$(document).ready(function(){$(".js__popup__youtube, .js__popup__vimeo").magnificPopup({disableOn:700,type:"iframe",mainClass:"mfp-fade",removalDelay:160,preloader:!1,fixedContentPos:!0})})};return{init:function(){handleMagnificPopup()}}}(),MagnificPopup=exports.MagnificPopup=_MagnificPopup;
},{}],26:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var _Parallax=function(){var handleParallax=function(){$(".js__parallax-window").parallax("50%",.1)};return{init:function(){handleParallax()}}}(),Parallax=exports.Parallax=_Parallax;
},{}],27:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var _Portfolio3Col=function(){var handlePortfolio=function(){$("#js__grid-portfolio-gallery").cubeportfolio({filters:"#js__filters-portfolio-gallery",layoutMode:"grid",mediaQueries:[{width:1500,cols:3},{width:1100,cols:3},{width:800,cols:3},{width:480,cols:2},{width:320,cols:1}],defaultFilter:"*",gapHorizontal:2,gapVertical:2,gridAdjustment:"responsive",caption:" ",lightboxDelegate:".cbp-lightbox",lightboxGallery:!0,lightboxTitleSrc:"data-title"})};return{init:function(){handlePortfolio()}}}(),Portfolio3Col=exports.Portfolio3Col=_Portfolio3Col;
},{}],28:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var _Scrollbar=function(){var handleScrollbar=function(){$(".js__scrollbar").mCustomScrollbar({theme:"minimal"})};return{init:function(){handleScrollbar()}}}(),Scrollbar=exports.Scrollbar=_Scrollbar;
},{}],29:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var _Swipers=function(){var registerEvents=function(){new Swiper(".js__swiper-one-item",{nextButton:".js__swiper-btn--next",prevButton:".js__swiper-btn--prev",speed:1e3,autoplay:5e3,loop:!0}),new Swiper(".js__swiper-slider",{pagination:".js__swiper-pagination",paginationClickable:!0,speed:1e3,autoplay:5e3,loop:!0}),new Swiper(".js__swiper-clients",{slidesPerView:5,spaceBetween:50,loop:!0,breakpoints:{1024:{slidesPerView:4,spaceBetween:50},992:{slidesPerView:3,spaceBetween:40},768:{slidesPerView:3,spaceBetween:30},600:{slidesPerView:2,spaceBetween:30},480:{slidesPerView:2,spaceBetween:0}}}),new Swiper(".js__swiper-news",{pagination:".js__swiper-pagination",paginationClickable:!0,slidesPerView:4,spaceBetween:30,loop:!0,breakpoints:{1024:{slidesPerView:4,spaceBetween:30},992:{slidesPerView:3,spaceBetween:30},768:{slidesPerView:2,spaceBetween:30},600:{slidesPerView:2,spaceBetween:30},480:{slidesPerView:1,spaceBetween:0}}}),new Swiper(".js__swiper-testimonials",{pagination:".js__swiper-fraction",paginationType:"fraction",paginationClickable:!0,nextButton:".js__swiper-btn--next",prevButton:".js__swiper-btn--prev",slidesPerView:1,speed:1e3,autoplay:7e3,loop:!0})};return{init:function(){registerEvents()}}}(),Swipers=exports.Swipers=_Swipers;
},{}],30:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var _Wow=function(){var handleWow=function(){new WOW({mobile:!1}).init()};return{init:function(){handleWow()}}}(),Wow=exports.Wow=_Wow;
},{}]},{},[22])
